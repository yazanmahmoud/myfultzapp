    ...
    <div id="right">
      ...
      <table>
        <tbody>
          ...
          {/* MLAs */}
          <tr><td className="label" colSpan="2"><a id="MLA" name="MLA">Members of the Legislative Assembly (MLAs)</a></td></tr>
          <tr>
          ...
          {/* MPs */}
          <tr><td className="label" colSpan="2"><a id="MP" name="MP">Members of Parliament (MPs)</a></td></tr>
          <tr>
          ...
          {/* Drive Thru Sponsors */}
          <tr><td className="label" colSpan="2"><a id="Tea" name="Tea">Event - Drive Thru Sponsors</a></td></tr>
          ...
          {/* Museums */}
          <tr><td className="label" colSpan="2"><a id="Museums" name="Museums">Nearby Historic Sites and Museums</a></td></tr>
          {[
          ...
          {/* Sackville Links */}
          <tr><td className="label" colSpan="2"><a id="Sackville" name="Sackville">Sackville Community Links</a></td></tr>
          {[
